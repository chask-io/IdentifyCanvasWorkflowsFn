# IdentifyCanvasWorkflowsFn

Analiza un canvas para identificar flujos de trabajo independientes y crea selecciones nombradas para cada uno
...
- The function name matches "IdentifyCanvasWorkflowsFn"
...
- AWS CloudWatch Logs: `/aws/lambda/IdentifyCanvasWorkflowsFn`
- Chask dashboard: Organization → Functions → IdentifyCanvasWorkflowsFn
